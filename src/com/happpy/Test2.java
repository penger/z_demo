...
import com.happpy.util.Rsource2String;
...
public class Test2 {
    ...
    public static void main(String[] args) {
    	String html = Rsource2String.getS("1.html");

        Document document = Jsoup.parse(html);
        List<String> list = Xsoup.select(html, "//table[@class=table and @class=table-striped]").list();
